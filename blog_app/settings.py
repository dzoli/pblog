...
SECRET_KEY = 'jhzbg7leje5m7zmw49nivuw4eyx168=k)047n=*gozfjr0_b)9'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Project level templates dir
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
print(os.path.join('this is base dir = ', BASE_DIR))
